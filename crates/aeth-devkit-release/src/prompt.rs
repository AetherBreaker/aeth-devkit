...
//!
//! Two decisions in a release need a human: "your tree is dirty, continue?" and "artefacts
//! for this version already exist, remove them?". Both require the user to type the word
//! `force` — a deliberate act, not a reflexive `y`. The prompt itself is a trait so tests can
//! feed canned answers and assert which questions were asked.
