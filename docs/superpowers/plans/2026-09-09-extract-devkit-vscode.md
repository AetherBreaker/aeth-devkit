...
## Execution notes (Parts A and B done 2026-09-09)

- Tasks 1–9 are complete: `AetherBreaker/devkit-vscode` exists (public, `main`, CI green), release `v2` carries `aeth-devkit-vscode-2.vsix`, and `aeth-devkit` 12.1.0 (PR #18, rebase-merged) is on SFTPyPI. Part C (Task 10) is the user's `setup-project` run in `devkit-vscode`, then the lock commit.
